...
class DrQDoubleCritic(nn.Module):
    ...
    def __call__(self, observations: jnp.ndarray,
        ...
        return DoubleCritic(self.hidden_dims, use_CReLU=self.use_CReLU)(x, actions)
...
class DrQPolicy(nn.Module):
    ...
    def __call__(self,
        ...
        return NormalTanhPolicy(self.hidden_dims, self.action_dim, use_CReLU=self.use_CReLU)(x,
                                                                   temperature)
